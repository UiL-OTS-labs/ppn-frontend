from api.rest.base import ResourceCollectionMetaclass, TypeCollectionMetaclass
...
class ResourceCollection(_CollectionMixin, metaclass=ResourceCollectionMetaclass):
    ...
    A resource collection does not have fields of its own, one needs to
    specify the resource contained in the collection instead. At the moment, a
    collection can only hold one type of resource and cannot hold different
    collections.
